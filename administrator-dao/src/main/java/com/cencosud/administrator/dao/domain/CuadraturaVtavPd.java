...
/**
 * 
 *  @description Clase CuadraturaVtavPd
 *
 */
...
public class CuadraturaVtavPd implements Serializable {
	...
	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQUENCE_CUADRATURA_VTAV_PD")
	@SequenceGenerator(name = "SEQUENCE_CUADRATURA_VTAV_PD", sequenceName = "SEQUENCE_CUADRATURA_VTAV_PD", allocationSize = 1)
