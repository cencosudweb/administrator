...
public class HorarioTrazabilidadActualizacion implements Serializable {
	...
	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQUENCE_HORARIO_TRA_ACT")
	@SequenceGenerator(name = "SEQUENCE_HORARIO_TRA_ACT", sequenceName = "SEQUENCE_HORARIO_TRA_ACT", allocationSize = 1)
