...
public class Padrino implements Serializable {
	...
	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQUENCE_PADRINOS")
	@SequenceGenerator(name = "SEQUENCE_PADRINOS", sequenceName = "SEQUENCE_PADRINOS", allocationSize = 1)
