...
public class CuadraturaCtlServicesTest {
	...
	public void getCuadraturaDoTest() {
		...
		int tranNbr = 0;
		String bogeda = "12";
		List<CuadraturaDoDTO> counts = cuadraturaDoServicesImpl.getCuadraturaDos(starttime+" 00:00:00", endtime+" 23:59:59", estado, start, limit);
	...
	public void getEcommerceSoporteVentaCountTest() {
		...
		int tranNbr = 0;
		String bogeda = "12";
		int counts = cuadraturaDoServicesImpl.getCuadraturaDoContar(starttime+" 00:00:00", endtime+" 23:59:59", estado);
		assertNotNull("Listado de counts es null", counts);
