...
public class CuadraturaCtlTest {
	...
	public void getCuadraturaCtlTest() {
		...
		int tranNbr = 0;
		String  bogeda = "12";
		List<CuadraturaCtl> counts = cuadraturaCtlDaoImpl.getCuadraturaCtls(carga, bogeda,0, starttime+" 00:00:00", endtime+" 23:59:59", tipo, tranNbr, estado, start, limit);
	...
	public void getEcommerceSoporteVentaCountTest() {
		...
		int tranNbr = 0;
		String bogeda = "12";
		int counts = cuadraturaCtlDaoImpl.getCuadraturaCtlContar(carga, bogeda,0, starttime+" 00:00:00", endtime+" 23:59:59", tipo, tranNbr, estado);
		assertNotNull("Listado de counts es null", counts);
