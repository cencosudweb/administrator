		...
		<div class="dialog">
			...
			<div class="block">
				...
				<div class="block-body">
				  ...
				  <form:form method="post" action="showQuestionsForgot" modelAttribute="newUserForgotPass" id="f_forgot">
						
						<form:label path="username" class="span12">Username o E-Mail</form:label>
					    <form:input path="username" id="dateInicio" cssClass="span12" maxlength="45"/>
					    </br><form:errors path="username" cssStyle="color:red"></form:errors></br>
					     	 	
						<a id="btn-show-question" class="btn btn-primary pull-right">Recuperar</a> 
