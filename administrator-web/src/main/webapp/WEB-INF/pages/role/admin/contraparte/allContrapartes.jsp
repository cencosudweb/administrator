...
<html>
  <head>
    ...
    <script src="<c:url value="/js/admin/contraparte/contraparte.all.js"/>" type="text/javascript"></script>
        ...
        <div class="container-fluid">
	        <div class="row-fluid">
				<div class="btn-toolbar">
				    <button id="btn-add-contraparte" class="btn btn-primary"><i class="icon-plus"></i> Nuevo</button>
				    <!--
				...
				<div class="well">
				    <table  id="example"  class="display" cellspacing="0" width="100%">
				      <thead>
				        <tr>
				          ...
				          <th align="left">Gerente</th>
				          <th style="width: 150px;">Acciones</th>
				        </tr>
				      </thead>
				      <tbody>
					  <c:if test="${!empty contrapartes}">
					      <c:forEach items="${contrapartes}" var="contraparte" varStatus="status">
					            <tr>
						          <td nowrap="nowrap">${status.count}</td>
						          <td nowrap="nowrap">${contraparte.description}</td>
						          <td nowrap="nowrap">${contraparte.gerente.description}</td>
						          <td>
						          	  <!--  <a href="resetPassword1?id=${user.id}" title="Restablecer Clave" ><i class="icon-signin"></i> Restablecer Pass</a><br />-->
						              <a href="editContraparte?id=${contraparte.id}" title="Editar" ><i class="icon-pencil"></i>Editar</a><br />
						              <a href="#myModal" class="lockUnlock" modo='U' idcontraparte="${contraparte.id}" title="Deshabilitar" role="button" data-toggle="modal" style="margin-right: 15px"><i class="icon-remove"></i>Eliminar</a><br />
						          </td>
						        </tr>
						</c:forEach>
				      </c:if>
					...
					<form method="post"  action="lockUnlockContraparte" id="f_lock">
		        			<input type="hidden" name="id" id="id_contraparte"/>
                            ...
                            rows: [
                                ...
                                return {
                                    ...
                                    cells: [
                                        ...
                                        { type: String, value: item.Gerente }
