			        ...
			        <tbody>
			        	<c:forEach items="${detalles}" var="detalle" varStatus="status">
							<tr>
								...
								<td>
									    <c:choose>
											<c:when test="${detalle.nOrdenDistribu != '' || detalle.nOrdenDistribu != null}">
												<small class="label label-danger"><i class="fa fa-info" aria-hidden="true"></i> Vacio</small>
											</c:when>
											<c:otherwise>
												<span class="label label-success">${detalle.nOrdenDistribu}</span>
											</c:otherwise>
										</c:choose>
								</td>
								<td>
								<c:choose>
											<c:when test="${detalle.fechaCreacionOrden != '' || detalle.fechaCreacionOrden != null}">
												<small class="label label-danger"><i class="fa fa-info" aria-hidden="true"></i> Vacio</small>
											</c:when>
											<c:otherwise>
												<span class="label label-success">${detalle.fechaCreacionOrden}</span>
											</c:otherwise>
										</c:choose>
