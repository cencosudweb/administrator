	        ...
	        <div class="row-fluid">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="btn-toolbar">
							<form class="form-inline" id="f_all_user" method="get" action="reporteCuadraturas">
				...
				<div class="well">
				    <table id="dataTables-example"  width="100%"  border="0" cellspacing="0" cellpadding="0" style="font-size:13px">
						<tr bgcolor="#305496" style="text-align:left; color:#FFF; font-size:13px; border: solid 1px #a6a6a6;">
							<th></th>
							<th align="left" WIDTH="50">Calculado&nbsp;</th>
							<th align="left" WIDTH="50">Referencia&nbsp;</th>
							<th align="left" WIDTH="50">Total&nbsp;</th>
							<th align="left" WIDTH="50">Asn&nbsp;</th>
							<th align="left" WIDTH="50">Cantidad&nbsp;</th>
							<th align="left" WIDTH="50">Diferencia&nbsp;</th>
						...
						try{
							...
							//SQLCumple = "SELECT SUBSTR(INVWMS.MOD_DATE_TIME,0,8) || ' 00:00:00' AS CALCULADO, SUBSTR(INVWMS.MOD_DATE_TIME,0,8) || ' 23:59:59' AS CALCULADO2, '#N/A' AS REFERENCIA,(SELECT SUM(INVWMS2.UNITS_RCVD) FROM INVENTARIO_WMS INVWMS2 WHERE INVWMS2.MOD_DATE_TIME >=  SUBSTR(INVWMS.MOD_DATE_TIME,0,8)  || ' 00:00:00' AND INVWMS2.MOD_DATE_TIME <= SUBSTR(INVWMS.MOD_DATE_TIME,0,8)  || ' 23:59:59'   AND INVWMS2.Tran_Type='603' AND INVWMS2.Tran_Code='02'  AND INVWMS2.Whse='012')  AS TOTAL, '#N/A' AS ASN,  '#N/A' AS CANTIDAD, '#N/A' AS DIF, '#N/A' AS ESTADO FROM INVENTARIO_WMS INVWMS WHERE INVWMS.MOD_DATE_TIME >=  '01/03/17 00:00:00' AND INVWMS.MOD_DATE_TIME <= '06/04/17 23:59:59' GROUP BY SUBSTR(MOD_DATE_TIME,0,8) ORDER BY SUBSTR(MOD_DATE_TIME,0,8) ASC ";
							//SQLCumple = "SELECT SUBSTR(INVWMS.MOD_DATE_TIME,0,8) || ' 00:00:00' AS CALCULADO, SUBSTR(INVWMS.MOD_DATE_TIME,0,8) || ' 23:59:59' AS CALCULADO2, '#N/A' AS REFERENCIA,(SELECT SUM(INVWMS2.UNITS_RCVD) FROM INVENTARIO_WMS INVWMS2 WHERE INVWMS2.MOD_DATE_TIME >=  SUBSTR(INVWMS.MOD_DATE_TIME,0,8)  || ' 00:00:00' AND INVWMS2.MOD_DATE_TIME <= SUBSTR(INVWMS.MOD_DATE_TIME,0,8)  || ' 23:59:59'   AND INVWMS2.Tran_Type='603' AND INVWMS2.Tran_Code='02'  AND INVWMS2.Whse='012')  AS TOTAL, '#N/A' AS ASN,  '#N/A' AS CANTIDAD, '#N/A' AS DIF, '#N/A' AS ESTADO FROM INVENTARIO_WMS INVWMS WHERE INVWMS.MOD_DATE_TIME >=  '"+starttime+" 00:00:00' AND INVWMS.MOD_DATE_TIME <= '"+endtime+" 23:59:59' GROUP BY SUBSTR(MOD_DATE_TIME,0,8) ORDER BY SUBSTR(MOD_DATE_TIME,0,8) ASC ";
							
							//Esto esd para el servidor
							SQLCumple = "SELECT TO_CHAR(INVWMS.MOD_DATE_TIME, 'DD/MM/YYYY')  AS CALCULADO, TO_CHAR(INVWMS.MOD_DATE_TIME, 'DD/MM/YYYY')  AS CALCULADO2, '#N/A' AS REFERENCIA,(SELECT SUM(INVWMS2.UNITS_RCVD) FROM INVENTARIO_WMS INVWMS2 WHERE 1 = 1 AND INVWMS2.MOD_DATE_TIME >=  TO_TIMESTAMP (TO_CHAR(INVWMS.MOD_DATE_TIME, 'DD/MM/YYYY')||' 00:00:00', 'DD/MM/YYYY HH24:MI:SS.FF') AND  INVWMS2.MOD_DATE_TIME <= TO_TIMESTAMP (TO_CHAR(INVWMS.MOD_DATE_TIME, 'DD/MM/YYYY')||' 23:59:59', 'DD/MM/YYYY HH24:MI:SS.FF')   AND INVWMS2.Tran_Type='603' AND INVWMS2.Tran_Code='02'  AND INVWMS2.Whse='012')  AS TOTAL, '#N/A' AS ASN,  '#N/A' AS CANTIDAD, '#N/A' AS DIF, '#N/A' AS ESTADO FROM INVENTARIO_WMS INVWMS WHERE 1 = 1 AND  MOD_DATE_TIME >=  TO_TIMESTAMP ('"+starttime+" 00:00:00', 'DD/MM/YYYY HH24:MI:SS.FF') AND MOD_DATE_TIME <= TO_TIMESTAMP ('"+endtime+" 23:59:59', 'DD/MM/YYYY HH24:MI:SS.FF') GROUP BY TO_CHAR(MOD_DATE_TIME, 'DD/MM/YYYY') ORDER BY TO_CHAR(MOD_DATE_TIME, 'DD/MM/YYYY') ASC ";
							
							//out.println("SQLCumple="+SQLCumple);
							//out.print("<br>");
							/*
							
							String SQLHideCumplimiento1 = "SELECT  INVWMS.REF_FIELD_1 AS REFERENCIA FROM INVENTARIO_WMS INVWMS WHERE INVWMS.MOD_DATE_TIME >=  TO_TIMESTAMP ('"+rsCumple.getString("CALCULADO")+" 00:00:00', 'DD/MM/YYYY HH24:MI:SS.FF') AND INVWMS.MOD_DATE_TIME <= TO_TIMESTAMP (' 00:00:00', 'DD/MM/YYYY HH24:MI:SS.FF')   GROUP BY INVWMS.REF_FIELD_1";
							out.println("SQLHideCumplimiento1="+SQLHideCumplimiento1);
							out.print("<br>");
							String SQLShowCumplimiento22 = "SELECT  INVWMS.REF_FIELD_1 AS REFERENCIA FROM INVENTARIO_WMS INVWMS WHERE INVWMS.MOD_DATE_TIME >=  TO_TIMESTAMP ('"+rsCumple.getString("CALCULADO")+" 00:00:00', 'DD/MM/YYYY HH24:MI:SS.FF') AND INVWMS.MOD_DATE_TIME <= TO_TIMESTAMP (' 00:00:00', 'DD/MM/YYYY HH24:MI:SS.FF')   GROUP BY INVWMS.REF_FIELD_1";
							out.println("SQLShowCumplimiento22="+SQLShowCumplimiento22);
							out.print("<br>");
							String SQLCumplimiento222 = "SELECT  INVWMS.REF_FIELD_1 AS REFERENCIA,SUM(INVWMS.UNITS_RCVD) AS TOTAL,(SELECT Citaan  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) AS ASN,(SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) AS CANTIDAD,( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) AS DIF,(CASE WHEN (SELECT Citaan  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) = 0 THEN 'Sin Actualizar'  ELSE CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) < 0  THEN 'Proceso Parcial'  ELSE  CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) > 0  THEN 'Diferencia'  ELSE  CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) = 0  THEN 'Procesado Ok'  ELSE  'N/A' END  END  END END ) AS ESTADO FROM INVENTARIO_WMS INVWMS WHERE INVWMS.MOD_DATE_TIME >= TO_TIMESTAMP (' 00:00:00', 'DD/MM/YYYY HH24:MI:SS.FF') AND INVWMS.MOD_DATE_TIME <= TO_TIMESTAMP ('"+rsCumple.getString("CALCULADO2")+" 23:59:59', 'DD/MM/YYYY HH24:MI:SS.FF') AND INVWMS.Tran_Type='603' AND INVWMS.Tran_Code='02'  AND INVWMS.Whse='012' "+prefixclauseReferencia+" GROUP BY INVWMS.REF_FIELD_1";
							out.println("SQLCumplimiento222="+SQLCumplimiento222);
							out.print("<br>");
							*/
						...
						%>
								...
								<script type="text/javascript">
									$(function(){
										...
										$("#ocultar_cumplimiento_<%=contarCumple%>").click(function() {
											...
											<%
								        	//SQLHideCumplimiento = "SELECT  INVWMS.REF_FIELD_1 AS REFERENCIA FROM INVENTARIO_WMS INVWMS WHERE INVWMS.MOD_DATE_TIME >=  '"+rsCumple.getString("CALCULADO")+"' AND INVWMS.MOD_DATE_TIME <= '"+rsCumple.getString("CALCULADO2")+"'   GROUP BY INVWMS.REF_FIELD_1";
								        	
								        	//Esto es para el servidor
								        	SQLHideCumplimiento = "SELECT  INVWMS.REF_FIELD_1 AS REFERENCIA FROM INVENTARIO_WMS INVWMS WHERE INVWMS.MOD_DATE_TIME >=  TO_TIMESTAMP ('"+rsCumple.getString("CALCULADO")+" 00:00:00', 'DD/MM/YYYY HH24:MI:SS.FF')  AND INVWMS.MOD_DATE_TIME <= TO_TIMESTAMP ('"+rsCumple.getString("CALCULADO")+" 23:59:59', 'DD/MM/YYYY HH24:MI:SS.FF')   GROUP BY INVWMS.REF_FIELD_1";
										...
										$("#mostrar_cumplimiento_<%=contarCumple%>").click(function() {
											...
											<%
								        	SQLShowCumplimiento = "SELECT  INVWMS.REF_FIELD_1 AS REFERENCIA FROM INVENTARIO_WMS INVWMS WHERE INVWMS.MOD_DATE_TIME >=  TO_TIMESTAMP ('"+rsCumple.getString("CALCULADO")+" 00:00:00', 'DD/MM/YYYY HH24:MI:SS.FF')  AND INVWMS.MOD_DATE_TIME <= TO_TIMESTAMP ('"+rsCumple.getString("CALCULADO")+" 23:59:59', 'DD/MM/YYYY HH24:MI:SS.FF')    GROUP BY INVWMS.REF_FIELD_1";
								...
								<%
								//SQLCumplimiento = "SELECT  INVWMS.REF_FIELD_1 AS REFERENCIA,SUM(INVWMS.UNITS_RCVD) AS TOTAL,(SELECT Citaan  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) AS ASN,(SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) AS CANTIDAD,( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) AS DIF,(CASE WHEN (SELECT Citaan  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) = 0 THEN 'Sin Actualizar'  ELSE CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) < 0  THEN 'Proceso Parcial'  ELSE  CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) > 0  THEN 'Diferencia'  ELSE  CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) = 0  THEN 'Procesado Ok'  ELSE  'N/A' END  END  END END ) AS ESTADO FROM INVENTARIO_WMS INVWMS WHERE INVWMS.MOD_DATE_TIME >=  '01/03/17 00:00:00' AND INVWMS.MOD_DATE_TIME <= '06/04/17 23:59:59' AND INVWMS.Tran_Type='603' AND INVWMS.Tran_Code='02'  AND INVWMS.Whse='012' GROUP BY INVWMS.REF_FIELD_1";
								//SQLCumplimiento = "SELECT  INVWMS.REF_FIELD_1 AS REFERENCIA,SUM(INVWMS.UNITS_RCVD) AS TOTAL,(SELECT Citaan  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) AS ASN,(SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) AS CANTIDAD,( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) AS DIF,(CASE WHEN (SELECT Citaan  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) = 0 THEN 'Sin Actualizar'  ELSE CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) < 0  THEN 'Proceso Parcial'  ELSE  CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) > 0  THEN 'Diferencia'  ELSE  CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) = 0  THEN 'Procesado Ok'  ELSE  'N/A' END  END  END END ) AS ESTADO FROM INVENTARIO_WMS INVWMS WHERE INVWMS.MOD_DATE_TIME >=  '"+rsCumple.getString("CALCULADO")+"' AND INVWMS.MOD_DATE_TIME <= '"+rsCumple.getString("CALCULADO2")+"' AND INVWMS.Tran_Type='603' AND INVWMS.Tran_Code='02'  AND INVWMS.Whse='012' GROUP BY INVWMS.REF_FIELD_1";
								//SQLCumplimiento = "SELECT  INVWMS.REF_FIELD_1 AS REFERENCIA,SUM(INVWMS.UNITS_RCVD) AS TOTAL,(SELECT Citaan  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) AS ASN,(SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) AS CANTIDAD,( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) AS DIF,(CASE WHEN (SELECT Citaan  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) = 0 THEN 'Sin Actualizar'  ELSE CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) < 0  THEN 'Proceso Parcial'  ELSE  CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) > 0  THEN 'Diferencia'  ELSE  CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) = 0  THEN 'Procesado Ok'  ELSE  'N/A' END  END  END END ) AS ESTADO FROM INVENTARIO_WMS INVWMS WHERE INVWMS.MOD_DATE_TIME >=  '"+rsCumple.getString("CALCULADO")+"' AND INVWMS.MOD_DATE_TIME <= '"+rsCumple.getString("CALCULADO2")+"' AND INVWMS.Tran_Type='603' AND INVWMS.Tran_Code='02'  AND INVWMS.Whse='012' "+prefixclauseReferencia+" GROUP BY INVWMS.REF_FIELD_1";
								
								//Esto es para el servidor
								SQLCumplimiento = "SELECT  INVWMS.REF_FIELD_1 AS REFERENCIA,SUM(INVWMS.UNITS_RCVD) AS TOTAL,(SELECT Citaan  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) AS ASN,(SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) AS CANTIDAD,( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) AS DIF,(CASE WHEN (SELECT Citaan  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan) = 0 THEN 'Sin Actualizar'  ELSE CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) < 0  THEN 'Proceso Parcial'  ELSE  CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) > 0  THEN 'Diferencia'  ELSE  CASE  WHEN ( (SELECT SUM(INVJDA2.Pounts)  FROM INVENTARIO_JDA INVJDA2 WHERE 1 = 1 AND INVJDA2.Poloc=12  AND INVJDA2.Pordat>160619 AND INVJDA2.Citaan = INVWMS.REF_FIELD_1 GROUP BY INVJDA2.Citaan ) - SUM(INVWMS.UNITS_RCVD) ) = 0  THEN 'Procesado Ok'  ELSE  'N/A' END  END  END END ) AS ESTADO FROM INVENTARIO_WMS INVWMS WHERE INVWMS.MOD_DATE_TIME >=  TO_TIMESTAMP ('"+rsCumple.getString("CALCULADO")+" 00:00:00', 'DD/MM/YYYY HH24:MI:SS.FF')  AND INVWMS.MOD_DATE_TIME <= TO_TIMESTAMP ('"+rsCumple.getString("CALCULADO")+" 23:59:59', 'DD/MM/YYYY HH24:MI:SS.FF')  AND INVWMS.Tran_Type='603' AND INVWMS.Tran_Code='02'  AND INVWMS.Whse='012' "+prefixclauseReferencia+" GROUP BY INVWMS.REF_FIELD_1";
								//SQLCumple = "SELECT SUBSTR(INVWMS.MOD_DATE_TIME,0,10) || ' 00:00:00' AS CALCULADO, SUBSTR(INVWMS.MOD_DATE_TIME,0,10) || ' 23:59:59' AS CALCULADO2, '#N/A' AS REFERENCIA,(SELECT SUM(INVWMS2.UNITS_RCVD) FROM INVENTARIO_WMS INVWMS2 WHERE INVWMS2.MOD_DATE_TIME >=  TO_TIMESTAMP (SUBSTR(  OBTENER_MONTH(INVWMS.MOD_DATE_TIME),0,10) || ' 00:00:00', 'DD/MM/YYYY HH24:MI:SS.FF') and INVWMS2.MOD_DATE_TIME <=  TO_TIMESTAMP (SUBSTR(OBTENER_MONTH(INVWMS.MOD_DATE_TIME),0,10) || ' 23:59:59', 'DD/MM/YYYY HH24:MI:SS.FF')   AND INVWMS2.Tran_Type='603' AND INVWMS2.Tran_Code='02'  AND INVWMS2.Whse='012')  AS TOTAL, '#N/A' AS ASN,  '#N/A' AS CANTIDAD, '#N/A' AS DIF, '#N/A' AS ESTADO FROM INVENTARIO_WMS INVWMS WHERE INVWMS.MOD_DATE_TIME >= TO_TIMESTAMP ('"+starttime+" 00:00:00', 'DD/MM/YYYY HH24:MI:SS.FF') AND INVWMS.MOD_DATE_TIME <= TO_TIMESTAMP ('"+endtime+" 23:59:59', 'DD/MM/YYYY HH24:MI:SS.FF') GROUP BY SUBSTR(MOD_DATE_TIME,0,10) ORDER BY SUBSTR(MOD_DATE_TIME,0,10) ASC ";
								//SQLCumplimiento = "SELECT TO_CHAR(INVWMS.MOD_DATE_TIME, 'DD/MM/YYYY')  AS CALCULADO, TO_CHAR(INVWMS.MOD_DATE_TIME, 'DD/MM/YYYY')  AS CALCULADO2, '#N/A' AS REFERENCIA,(SELECT SUM(INVWMS2.UNITS_RCVD) FROM INVENTARIO_WMS INVWMS2 WHERE 1 = 1 AND INVWMS2.MOD_DATE_TIME >=  TO_TIMESTAMP (TO_CHAR(INVWMS.MOD_DATE_TIME, 'DD/MM/YYYY')||' 00:00:00', 'DD/MM/YYYY HH24:MI:SS.FF') AND  INVWMS2.MOD_DATE_TIME <= TO_TIMESTAMP (TO_CHAR(INVWMS.MOD_DATE_TIME, 'DD/MM/YYYY')||' 23:59:59', 'DD/MM/YYYY HH24:MI:SS.FF')   AND INVWMS2.Tran_Type='603' AND INVWMS2.Tran_Code='02'  AND INVWMS2.Whse='012')  AS TOTAL, '#N/A' AS ASN,  '#N/A' AS CANTIDAD, '#N/A' AS DIF, '#N/A' AS ESTADO FROM INVENTARIO_WMS INVWMS WHERE 1 = 1 AND AND MOD_DATE_TIME >=  TO_TIMESTAMP ('"+starttime+" 00:00:00', 'DD/MM/YYYY HH24:MI:SS.FF') AND MOD_DATE_TIME <= TO_TIMESTAMP ('"+starttime+" 23:59:59', 'DD/MM/YYYY HH24:MI:SS.FF') GROUP BY TO_CHAR(MOD_DATE_TIME, 'DD/MM/YYYY') ORDER BY TO_CHAR(MOD_DATE_TIME, 'DD/MM/YYYY') ASC ";
