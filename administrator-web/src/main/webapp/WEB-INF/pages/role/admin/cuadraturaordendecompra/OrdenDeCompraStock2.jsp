					...
					<div class="panel-body">
						<div class="btn-toolbar">
							<form class="form-inline" id="f_all_user" method="get" action="reporteOrdenDeCompraStock">
        						...
        						<label>DO EOM</label>
								<br>
       							 <input class="form-control span12" style="width:200px;" placeholder="Buscar DO EOM..." name="orden_distribucion" id="orden_distribucion" type="text" value="<%if(request.getParameter("orden_distribucion") != null){%><%=request.getParameter("orden_distribucion")%><%}else{%><%=""%><% } %>">
        						</div>
								<br>
								<div class="form-group">
        						<label>Solicitud EOM</label>
								<br>
       							 <input class="form-control span12" style="width:200px;" placeholder="Buscar Solicitud EOM..." name="solicitud_original" id="solicitud_original" type="text" value="<%if(request.getParameter("solicitud_original") != null){%><%=request.getParameter("solicitud_original")%><%}else{%><%=""%><% } %>">
        						</div>
								<br>
								<div class="form-group">
							  ...
							  <%
									...
									try{
										...
										SQLFecha = 	" SELECT " +
													...
													" NVL( SUM(CASE WHEN JDA_STOCK.EX14ERROR LIKE '%No se especifica rut de cliente%' THEN 1 ELSE 0 END ),0 ) as totalOcError, " + 
								...
								try{
									...
									conn.setAutoCommit(false);
									  ...
									  SQLCumple = " SELECT " + 
												...
												//"  CASE WHEN JDA_STOCK.EX14ERROR LIKE '%La OC se cargo correctamente%' THEN 'Oc Cargada' ELSE  CASE WHEN JDA_STOCK.EX14ERROR LIKE '%No se especifica rut de cliente%' THEN 'Oc Error' ELSE '-' END  END as estado, " +
												"  CASE WHEN JDA_STOCK.EX14ERROR LIKE '%La OC se cargo correctamente%' THEN 'Oc Cargada' ELSE CASE WHEN JDA_STOCK.EX14ERROR LIKE '%No se especifica rut de cliente%' THEN 'Oc Error' ELSE CASE WHEN JDA_STOCK.EX14ERROR LIKE '%-1%' THEN 'Oc Sin Error Mensaje' ELSE  '-' END  END END as estado, " +
									...
									SQLCumple = " SELECT " + 
												...
												"  JDA_STOCK.POVNUM, " +
												"  JDA_STOCK.EX14ERROR, " +
												"  CASE WHEN JDA_STOCK.EX14ERROR LIKE '%La OC se cargo correctamente%' THEN 'Oc Cargada' ELSE 'Oc Error' END as estado, " +
												"  CASE WHEN JDA_STOCK.DESPA IS NULL THEN '-' ELSE JDA_STOCK.DESPA END as DESPA " +
