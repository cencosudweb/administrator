						...
						%>
								...
								%>
									...
									<tr id="cumplimiento_<%=contarCumple%>_<%=contarCumplimiento%>" style="background-color:#d9e1f2;text-align:left;font-size:13px;color:#000000;display:none" >
										...
										<table>
											<tr>
												<td nowrap="nowrap"><%=rsCumplimiento.getString("POVNUM")%></td>
											</tr>
										</table>
										</td>	 
										<td nowrap="nowrap">
										...
										<table>
											<tr>
												<td nowrap="nowrap"><%=rsCumplimiento.getString("NUMDO")%></td>
											</tr>
										</table>
										</td> 
										<td nowrap="nowrap">
										...
										<table>
											<tr>
												<td nowrap="nowrap"><%=rsCumplimiento.getString("POFECE")%></td>
											</tr>
										</table>
										</td>	 
										<td nowrap="nowrap">
										...
										<table>
											<tr>
												<td nowrap="nowrap"><%=rsCumplimiento.getString("EX14ERROR")%></td>
											</tr>
										</table>
										</td>	 
										<td nowrap="nowrap">
										...
										<table>
											<tr>
												<td nowrap="nowrap"><%=rsCumplimiento.getString("POHORE")%></td>
											</tr>
										</table>
										</td>	 
									</tr>
