...
if (request.getParameterValues("descripcion_empresa") != null) {
	...
	for(String descripcionEmpresa: descripcionEmpresas) {
		...
		prefixclauseTipoGuia += " TC.ID_DESC_EMP = " +  descripcionEmpresa + " OR ";
		prefixclauseTipoGuia2 += " TC2.ID_DESC_EMP = " +  descripcionEmpresa + " OR ";
		prefixclauseTipoGuiaExport += " TC2.ID_DESC_EMP = " +  descripcionEmpresa + " OR ";

	}
	prefixclause+= " TC.ID_DESC_EMP = -1) ";
	prefixclauseSub+= " TTC2.ID_DESC_EMP = -1) ";

	prefixclauseTipoGuia+= " TC.ID_DESC_EMP = -1) ";
	prefixclauseTipoGuia2+= " TC2.ID_DESC_EMP = -1) ";
	prefixclauseTipoGuiaExport+= " TC2.ID_DESC_EMP = -1) ";
...
<html>
  ...
  <!--<![endif]-->
    ...
    <div class="content">
        <div class="header">
            <h1 class="page-title">Reporte Kpi Cumplimiento Logistico Dinamico 2</h1>
        </div>
        
        <ul class="breadcrumb">
            <li><a href="home">Home</a> <span class="divider">/</span></li>
            <li class="active">Reporte Kpi Cumplimiento Logistico Dinamico 2</li>
        </ul>
	        ...
	        <div class="row-fluid">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="btn-toolbar">
							<form class="form-inline" id="f_all_user" method="get" action="reportePanelDinamico2">
