	        ...
	        <div class="row-fluid">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="btn-toolbar">
							<form class="form-inline" id="f_all_user" method="get" action="reportePanelDinamicoSemanal">
								...
								<script type="text/javascript">
									$(function(){
										$("#ocultar_cumplimiento_<%=contarCumple%>").click(function() {
											...
											<%
								        	SQLHideCumplimiento = "SELECT  C1.CUMPLE_RESUMEN from CUMPLIMIENTO C1 WHERE  1=1 AND C1.CUMPLE = '"+rsCumple.getString("CUMPLE")+"' GROUP BY C1.CUMPLE_RESUMEN ORDER BY C1.CUMPLE_RESUMEN ASC";
