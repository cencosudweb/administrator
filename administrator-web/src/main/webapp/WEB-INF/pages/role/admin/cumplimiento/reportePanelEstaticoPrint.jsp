        ...
        <div class="container-fluid">
	        <div class="row-fluid">
				<div class="btn-toolbar">
					<a class="btn" href="downloadExcelCumplimientokpiWeb?fechaIni=<%=starttime%>&fechaTer=<%=starttime%>&tipo_orden=<%=tipoOrdenes%>">Export Excel<%=tipoOrdenes%></a>
					<a class="btn" href="viewCSVCumplimientokpiWeb?fechaIni=<%=starttime%>&fechaTer=<%=starttime%>">Export Csv</a>
				...
				<div class="well" style="overflow:scroll;">
					<%
						...
						try{
							...
							connFecha = DriverManager.getConnection(InicializarMIS.getPropiedad("jdbc.databaseurl"),"kpiweb","kpiweb");//
