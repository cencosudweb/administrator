				...
				<div class="well">
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active in" id="home">
							<form:form method="post" action="savePauta" enctype="multipart/form-data" modelAttribute="newPauta" id="f_add_pauta">
					        ...
					        <form:input id="descripcionIssue"  path="descripcionIssue"  cssStyle="width:300px" maxlength="3000" />
					        </br><form:errors path="descripcionIssue" cssStyle="color:red"></form:errors></br>
					    	
					    	
					        <form:label path="observacion">* Observacion</form:label>
					        <form:textarea id="observacion" path="observacion" cssStyle="width:300px" maxlength="3000"/>
