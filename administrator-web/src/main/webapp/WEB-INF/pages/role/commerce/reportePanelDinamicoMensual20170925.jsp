...
String currentDateMonth = ft2.format(dNowM);
String month = request.getParameter("fromstatsmonth_sday") != null || request.getParameter("fromstatsmonth_sday") != ""?request.getParameter("fromstatsmonth_sday"):currentDateMonth;
String starttimemonth = "";
if (request.getParameter("fromstatsmonth_sday") != null) {
	starttimemonth =  DateUtils.restarDiasFecha(String.valueOf(currentDateMonth), "1");
} else {
	starttimemonth =  DateUtils.restarDiasFecha(String.valueOf(currentDateMonth), "1");
}
//out.println("starttimemonth="+starttimemonth);
//restarDiasFecha("2017-05", "1")
...
if (request.getParameterValues("tipo_estado") != null) {
	...
	for(String cumple: cumples) {
		prefixclause += " TC.ID_CUMPLE = " +  cumple + " OR ";
		prefixclauseSub += " TTC2.ID_CUMPLE = " +  cumple + " OR ";
		
		prefixclauseCumple += " TC.ID_CUMPLE = " +  cumple + " OR ";
		prefixclauseCumple2 += " TC2.ID_CUMPLE = " +  cumple + " OR ";
		prefixclauseCumpleExport += " TC2.ID_CUMPLE = " +  cumple + " OR ";

	}
	prefixclause += " TC.ID_CUMPLE = -1)";
	prefixclauseSub += " TTC2.ID_CUMPLE = -1)";
	
	prefixclauseCumple += " TC.ID_CUMPLE = -1)";
	prefixclauseCumple2 += " TC2.ID_CUMPLE = -1)";
	prefixclauseCumpleExport += " TC2.ID_CUMPLE = -1)";
...
if (request.getParameterValues("cliente_retira") != null) {
	...
	for(String clienteRetira: clienteRetiras) {
		...
		prefixclauseClienteRetira += " TC.ID_CLIENTE_RETIRA = " +  clienteRetira + " OR ";
		prefixclauseClienteRetira2 += " TC2.ID_CLIENTE_RETIRA = " +  clienteRetira + " OR ";
		prefixclauseClienteRetiraExport += " TC2.ID_CLIENTE_RETIRA = " +  clienteRetira + " OR ";

	}
	prefixclause += " TC.ID_TIPO_ORDEN = -1) ";
	prefixclauseSub += " TTC2.ID_TIPO_ORDEN = -1) ";

	prefixclauseClienteRetira += " TC.ID_TIPO_ORDEN = -1) ";
	prefixclauseClienteRetira2 += " TC2.ID_TIPO_ORDEN = -1) ";
	prefixclauseClienteRetiraExport += " TC2.ID_TIPO_ORDEN = -1) ";
} 
...
if (request.getParameterValues("descripcion_empresa") != null) {
	...
	for(String descripcionEmpresa: descripcionEmpresas) {
		...
		prefixclauseDescripcionEmpresa += " TC.ID_DESC_EMP = " +  descripcionEmpresa + " OR ";
		prefixclauseDescripcionEmpresa2 += " TC2.ID_DESC_EMP = " +  descripcionEmpresa + " OR ";
		prefixclauseDescripcionEmpresaExport += " TC2.ID_DESC_EMP = " +  descripcionEmpresa + " OR ";

	}
	prefixclause+= "TC.ID_DESC_EMP = -1)";
	prefixclauseSub+= "TTC2.ID_DESC_EMP = -1)";

	prefixclauseDescripcionEmpresa+= " TC.ID_DESC_EMP = -1)";
	prefixclauseDescripcionEmpresa2+= " TC2.ID_DESC_EMP = -1)";
	prefixclauseDescripcionEmpresaExport+= " TC2.ID_DESC_EMP = -1)";
...
if (request.getParameterValues("tipo_guia") != null) {
	...
	prefixclause +=" AND ( TC.ID_TIPOGUI = 0)";
	prefixclauseSub +=" AND ( TC.ID_TIPOGUI = 0)";
	
	prefixclauseTipoGuia+= " TC.ID_TIPOGUI = 0) ";
	prefixclauseTipoGuia2+= " TC2.ID_TIPOGUI = 0) ";
	prefixclauseTipoGuiaExport+= " TC2.ID_TIPOGUI = 0) ";
}*/
...
if (request.getParameterValues("tipo_horario") != null) {
	...
	for(String tipoHorario: tipoHorarios) {
		prefixclause += " TC.ID_HORARIO = " +  tipoHorario + " OR ";
		prefixclauseSub += " TTC2.ID_HORARIO = " +  tipoHorario + " OR ";

		prefixclauseHorario += " TC.ID_HORARIO = " +  tipoHorario + " OR ";
		prefixclauseHorario2 += " TC2.ID_HORARIO = " +  tipoHorario + " OR ";
		prefixclauseHorarioExport += " TC2.ID_HORARIO = " +  tipoHorario + " OR ";

	}
	prefixclause+= " TC.ID_HORARIO = -1) ";
	prefixclauseSub += " TTC2.ID_HORARIO = -1) ";

	prefixclauseHorario+= " TC.ID_HORARIO = -1) ";
	prefixclauseHorario2+= " TC2.ID_HORARIO = -1) ";
	prefixclauseHorarioExport+= " TC2.ID_HORARIO = -1) ";
...
if (request.getParameterValues("venta_empresa") != null) {
	...
	for(String ventasEmpresa: ventasEmpresas) {
		prefixclause += " TC.ID_VENTA_EMPRESA = " +  ventasEmpresa + " OR ";
		prefixclauseSub += " TTC2.ID_VENTA_EMPRESA = " +  ventasEmpresa + " OR ";

		prefixclauseVentaEmpresa += " TC.ID_VENTA_EMPRESA = " +  ventasEmpresa + " OR ";
		prefixclauseVentaEmpresa2 += " TC2.ID_VENTA_EMPRESA = " +  ventasEmpresa + " OR ";
		prefixclauseVentaEmpresaExport += " TC2.ID_VENTA_EMPRESA = " +  ventasEmpresa + " OR ";

	}
	prefixclause+= " TC.ID_VENTA_EMPRESA = -1) ";
	prefixclauseSub+= " TTC2.ID_VENTA_EMPRESA = -1) ";

	prefixclauseVentaEmpresa+= " TC.ID_VENTA_EMPRESA = -1) ";
	prefixclauseVentaEmpresa2+= " TC2.ID_VENTA_EMPRESA = -1) ";
	prefixclauseVentaEmpresaExport+= " TC2.ID_VENTA_EMPRESA = -1) ";
...
<html>
  ...
  <!--<![endif]-->
    ...
    <div class="content">
        <div class="header">
            <h1 class="page-title">Reporte Kpi Cumplimiento Logistico Dinamico Mensual</h1>
        </div>
        
        <ul class="breadcrumb">
            <li><a href="home">Home</a> <span class="divider">/</span></li>
            <li class="active">Reporte Kpi Cumplimiento Logistico Dinamico Mensual</li>
        </ul>
	        ...
	        <div class="row-fluid">
							...
							<form class="form-inline" id="f_all_user" method="get" action="reportePanelDinamicoMensual">
								...
								<div class="form-group" >
			                       ...
			                       &nbsp;
									...
									<select name="fromstatsmonth_sday" id="fromstatsmonth_sday" class="form-control" style="width: 130px">
					             <%
				...
				<div class="well" style="overflow:scroll;">
					...
					try{
						...
						SQLFecha = 	"	SELECT  " + 
									"		SUBSTR(TC.FECHA_COMPROMISO_EOM,0,7) AS FECHA_COMPROMISO_EOM  " +
									"		,(REPLACE(REPLACE (REPLACE (CONCAT(''''||SUBSTR(TC.FECHA_COMPROMISO_EOM,0,7),''''), '00:', ''), '00',''),' ','')) AS FECHA_COMPROMISO_EOM_GRAFICO" +
									...
									"	WHERE 1 = 1 " +
									"	" + prefixclause +
									" 	AND TC.FECHA_COMPROMISO_EOM >= '"+request.getParameter("fromstatsmonth_sday")+"-01' AND TC.FECHA_COMPROMISO_EOM <= '"+request.getParameter("fromstatsmonth_sday")+"-31'" +
									"	GROUP BY SUBSTR(TC.FECHA_COMPROMISO_EOM,0,7) " +
									"	";
						//out.println("<BR>");
				    ...
				    <table id="dataTables-example"  width="100%"  border="0" cellspacing="0" cellpadding="0" style="font-size:13px">
						...
						try{
							...
							SQLCumple = "	SELECT  " +
										...
										"	WHERE  1 = 1  " + 
										" 	" + prefixclause + 
										//" 	AND TC.FECHA_COMPROMISO_EOM >= TO_CHAR(to_date((to_char(ADD_MONTHS(TO_CHAR(to_date('"+request.getParameter("fromstatsmonth_sday")+"', 'YYYY-MM-DD'), 'DD/MM/YY'),-1))), 'DD/MM/YY'), 'YYYY-MM-DD') AND TC.FECHA_COMPROMISO_EOM <= '"+request.getParameter("fromstatsmonth_sday")+"'" +
											" 	AND TC.FECHA_COMPROMISO_EOM >= '"+request.getParameter("fromstatsmonth_sday")+"-01' AND TC.FECHA_COMPROMISO_EOM <= '"+request.getParameter("fromstatsmonth_sday")+"-31'" +
										...
										"	GROUP BY TC.ID_CUMPLE, EC.DESCRIPTION ORDER BY TC.ID_CUMPLE ASC" + 
										"	";
							//out.print("<br>");
						...
						%>
								...
								$(function(){
									$("#ocultar_cumplimiento_<%=contarCumple%>").click(function() {
										<%
							        	SQLHideCumplimiento = "SELECT  TC.ID_CUMPLE_RESUMEN from CUMPLIMIENTO_KPIWEB TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+request.getParameter("fromstatsmonth_sday")+"-01' AND TC.FECHA_COMPROMISO_EOM <= '"+request.getParameter("fromstatsmonth_sday")+"-31' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" GROUP BY TC.ID_CUMPLE_RESUMEN ORDER BY TC.ID_CUMPLE_RESUMEN ASC";
	                                    ...
	                                    %>
											...
											<%
											SQLHideCumpleResumen = "SELECT  TC.ID_CUMPLIMIENTO_2 from CUMPLIMIENTO_KPIWEB TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+request.getParameter("fromstatsmonth_sday")+"-01' AND TC.FECHA_COMPROMISO_EOM <= '"+request.getParameter("fromstatsmonth_sday")+"-31' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsHideCumplimiento.getInt("ID_CUMPLE_RESUMEN")+" GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
											...
											%>
												...
												<%
												SQLHideResponsable = "SELECT  TC.ID_RESPONSABLE from CUMPLIMIENTO_KPIWEB TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+request.getParameter("fromstatsmonth_sday")+"-01' AND TC.FECHA_COMPROMISO_EOM <= '"+request.getParameter("fromstatsmonth_sday")+"-31' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsHideCumplimiento.getInt("ID_CUMPLE_RESUMEN")+" AND TC.ID_CUMPLIMIENTO_2 = "+rsHideCumpleResumen.getInt("ID_CUMPLIMIENTO_2")+" GROUP BY TC.ID_RESPONSABLE ORDER BY TC.ID_RESPONSABLE ASC";
									...
									$("#mostrar_cumplimiento_<%=contarCumple%>").click(function() {
										<%
							        	SQLShowCumplimiento = "SELECT  TC.ID_CUMPLE_RESUMEN from CUMPLIMIENTO_KPIWEB TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+request.getParameter("fromstatsmonth_sday")+"-01' AND TC.FECHA_COMPROMISO_EOM <= '"+request.getParameter("fromstatsmonth_sday")+"-31' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" GROUP BY TC.ID_CUMPLE_RESUMEN ORDER BY TC.ID_CUMPLE_RESUMEN ASC";
	                                    ...
	                                    %>
											...
											<%
											SQLShowCumpleResumen = "SELECT  TC.ID_CUMPLIMIENTO_2 from CUMPLIMIENTO_KPIWEB TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+request.getParameter("fromstatsmonth_sday")+"-01' AND TC.FECHA_COMPROMISO_EOM <= '"+request.getParameter("fromstatsmonth_sday")+"-31' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsShowCumplimiento.getInt("ID_CUMPLE_RESUMEN")+"  GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
													...
													<table>
														<tr>
															...
															for(int h=0;h<resultTotal.size();h++) {
																if( String.valueOf(resultTotal.get(h).getFechaCompromiso().substring(0,7)).equals(String.valueOf(rsShowFecha.getString("FECHA_COMPROMISO_EOM").substring(0,7)))) {
								...
								SQLCumplimiento = 	"	SELECT  " +
													...
													"	GROUP BY TC.ID_CUMPLE_RESUMEN, ECR.DESCRIPTION  ORDER BY TC.ID_CUMPLE_RESUMEN ASC" + 
													"	";
								//out.print("<br>");
								...
								%>
									...
									$(function(){
										$("#ocultar_cumple_resumen_<%=contarCumple%>_<%=contarCumplimiento%>").click(function() {
											<%
											SQLHideCumpleResumen = "SELECT  TC.ID_CUMPLIMIENTO_2 from CUMPLIMIENTO_KPIWEB TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+request.getParameter("fromstatsmonth_sday")+"-01' AND TC.FECHA_COMPROMISO_EOM <= '"+request.getParameter("fromstatsmonth_sday")+"-31' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento.getInt("ID_CUMPLE_RESUMEN")+" GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
											psHideCumpleResumen = conn.prepareStatement(SQLHideCumpleResumen, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
											rsHideCumpleResumen = psHideCumpleResumen.executeQuery();
											conn.commit();
											int contarHideCumpleResumen = 0;
											...
											%>
												...
												<%
												SQLHideResponsable = "SELECT  TC.ID_RESPONSABLE from CUMPLIMIENTO_KPIWEB TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+request.getParameter("fromstatsmonth_sday")+"-01' AND TC.FECHA_COMPROMISO_EOM <= '"+request.getParameter("fromstatsmonth_sday")+"-31' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+"  AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento.getInt("ID_CUMPLE_RESUMEN")+" AND TC.ID_CUMPLIMIENTO_2 = "+rsHideCumpleResumen.getInt("ID_CUMPLIMIENTO_2")+" GROUP BY TC.ID_RESPONSABLE ORDER BY TC.ID_RESPONSABLE ASC";
												psHideResponsable = conn.prepareStatement(SQLHideResponsable, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
												rsHideResponsable = psHideResponsable.executeQuery();
												conn.commit();
												int contarHideResponsable = 0;
										...
										$("#mostrar_cumple_resumen_<%=contarCumple%>_<%=contarCumplimiento%>").click(function() {
											<%
											SQLShowCumpleResumen = "SELECT  TC.ID_CUMPLIMIENTO_2 from CUMPLIMIENTO_KPIWEB TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+request.getParameter("fromstatsmonth_sday")+"-01' AND TC.FECHA_COMPROMISO_EOM <= '"+request.getParameter("fromstatsmonth_sday")+"-31' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento.getInt("ID_CUMPLE_RESUMEN")+" GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
											psShowCumpleResumen = conn.prepareStatement(SQLShowCumpleResumen, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
											rsShowCumpleResumen = psShowCumpleResumen.executeQuery();
											conn.commit();
											int contarShowCumpleResumen = 0;
									...
									SQLCumpleResumen = 	"	SELECT  " + 
														...
														"	GROUP BY TC.ID_CUMPLIMIENTO_2, EC.DESCRIPTION ORDER BY TC.ID_CUMPLIMIENTO_2 ASC" +
														"	";
									//out.print("<br>");
									...
									%>
										...
										$(function(){
											...
											$("#mostrar_responsable_<%=contarCumple%>_<%=contarCumplimiento%>_<%=contarCumpleResumen%>").click(function() {
												<%
												SQLShowResponsable = "SELECT  TC.ID_RESPONSABLE from CUMPLIMIENTO_KPIWEB TC WHERE  1 = 1  AND TC.FECHA_COMPROMISO_EOM >= '"+request.getParameter("fromstatsmonth_sday")+"-01' AND TC.FECHA_COMPROMISO_EOM <= '"+request.getParameter("fromstatsmonth_sday")+"-31' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento.getInt("ID_CUMPLE_RESUMEN")+" AND TC.ID_CUMPLIMIENTO_2 = "+rsCumpleResumen.getInt("ID_CUMPLIMIENTO_2")+"  GROUP BY TC.ID_RESPONSABLE ORDER BY TC.ID_RESPONSABLE ASC";
										...
										SQLResponsable = 	"	SELECT " + 
															...
															"	AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento.getInt("ID_CUMPLE_RESUMEN")+" " +
															"	AND TC.ID_CUMPLIMIENTO_2 = "+rsCumpleResumen.getInt("ID_CUMPLIMIENTO_2")+" " + 
															"	GROUP BY TC.ID_RESPONSABLE, ER.DESCRIPTION ORDER BY TC.ID_RESPONSABLE ASC " + 
															"	";
										//out.print("<br>");
