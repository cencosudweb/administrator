				...
				<div class="well" style="overflow: scroll;">
				    <table id="dataTables-example"  width="100%"  border="0" cellspacing="0" cellpadding="0" style="font-size:13px">
						...
						try{
							...
							SQLCumple = "SELECT  C1.CUMPLE from CUMPLIMIENTO C1 WHERE  1 = 1 AND C1.FECHA_COMPROMISO_EOM >= REPLACE(TO_CHAR(to_date('"+starttime+"', 'YYYY-MM-DD')-8, 'YYYY/MM/DD'),'/','-') AND C1.FECHA_COMPROMISO_EOM <= '"+starttime+"' " + prefixclauseCumple + "  GROUP BY C1.CUMPLE ORDER BY C1.CUMPLE ASC";
							//out.print("<br>");
