...
app.factory('LoginService', ['$http','$q', function( $http, $q ){
	...
	var self = {
		...
		login: function( datos, day, month, year  ){
			...
			$http.get('http://localhost:8081/administrator-ws/kitserviceRS/service/cumplimiento?fechaCompromisoEom='+year+'-'+month+'-'+day+'&tipoOrden='+datos.orden+'&tipoVenta='+datos.venta+'&tipoGuia='+datos.guia)
